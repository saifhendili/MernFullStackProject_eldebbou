...
const SearchProduct =({GetPanier,AddPanier,GetProducts,Addwishlist ,panier:{panier},product:{products,loading},auth:{user},profile:{searchpro}}) =>{
            ...
            <div className="col-lg-9 col-md-12">
              <div className="shop-p">
                ...
                <div className="shop-p__collection">
                  ...
                  {products.filter(el =>
                            el.name.toLowerCase().includes(searchpro.toLowerCase())).map((x,i)=>( 
x.dealType == dealType?(
...
export default connect(mapStateToProps, {GetProducts,Addwishlist,AddPanier,GetPanier})(SearchProduct);
