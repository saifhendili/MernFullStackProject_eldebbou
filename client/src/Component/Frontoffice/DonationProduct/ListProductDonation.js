                ...
                <div className="shop-p__toolbar u-s-m-b-30">
                  <div className="shop-p__meta-wrap u-s-m-b-60">
                    ...
                    <div className="shop-p__meta-text-2">
                      ...
                      <a className="gl-tag btn--e-brand-shadow"  value="Donation" >Donation</a>
    </div>
...
export default connect(mapStateToProps, {GetProducts})(ListProductDonation);
